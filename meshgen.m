...
alpha = 0.174532925;  % Angle of attack (in radians)(10 degree)
NACA = [0 0 1 2];     % NACA 4-digit designation as a row vector;

% Mesh dimensions
scale = 1;            % Scaling factor
H = 15;                % *Half* height of channel
W = 0.5;              % *Half* depth of foil (y-direction)
D = 20;               % Length of downstream section

% Mesh resolution parameters
Ni = 450;             % Number of interpolation points along the foil
Nx = 250;             % Number of mesh cells along the foil
ND = 200;             % Number of cells in the downstream direction
NT = 150;             % Number of cells the transverse direction
NW = 1;               % Number of cells in the y-direction (along the foil axis)

% Expansion rates
ExpT = 520;           % Expansion rate in transverse direction
ExpD = 150;           % Expansion rate in the downstream direction
ExpArc = 70;          % Expansion rate along the inlet arc
...
fprintf(fo, 'blocks \n');
fprintf(fo, '( \n');
fprintf(fo, '    hex (4 5 1 0 16 17 13 12)     (%d %d %d) edgeGrading (1 %f %f 1 %f %f %f %f 1 1 1 1) \n', Nleading, NT, NW, 1/ExpArc, 1/ExpArc, ExpT, ExpT, ExpT, ExpT);
fprintf(fo, '    hex (5 7 2 1 17 19 14 13)     (%d %d %d) simpleGrading (1 %f 1) \n', Ntrailing, NT, NW, ExpT);
fprintf(fo, '    hex (7 8 3 2 19 20 15 14)     (%d %d %d) simpleGrading (%f %f 1) \n', ND, NT, NW, ExpD, ExpT);
fprintf(fo, '    hex (16 18 21 12 4 6 9 0)     (%d %d %d) edgeGrading (1 %f %f 1 %f %f %f %f 1 1 1 1) \n', Nleading, NT, NW, 1/ExpArc, 1/ExpArc, ExpT, ExpT, ExpT, ExpT);
fprintf(fo, '    hex (18 19 22 21 6 7 10 9)    (%d %d %d) simpleGrading (1 %f 1) \n', Ntrailing, NT, NW, ExpT);
fprintf(fo, '    hex (19 20 23 22 7 8 11 10)   (%d %d %d) simpleGrading (%f %f 1) \n', ND, NT, NW, ExpD, ExpT);
